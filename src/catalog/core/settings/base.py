...
ROOT_URLCONF = "catalog.core.urls"
# https://docs.djangoproject.com/en/dev/ref/settings/#wsgi-application
WSGI_APPLICATION = "catalog.core.wsgi.application"
...
MIGRATION_MODULES = {"sites": "catalog.core.contrib.sites.migrations"}
...
if AWS_ACCESS_KEY_ID := env("DJANGO_AWS_ACCESS_KEY_ID", default=None):
    ...
    STORAGES["default"]["backend"] = "catalog.core.storages.MediaRootS3Boto3Storage"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "catalog.users.context_processors.allauth_settings",
                "catalog.core.context_processors.context_settings",
            ],
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "catalog.users.adapters.AccountAdapter"
if env("SOCIALACCOUNT_ADAPTER", default=None):
    SOCIALACCOUNT_ADAPTER = env("SOCIALACCOUNT_ADAPTER")

# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "catalog.users.forms.UserSignupForm"}
...
# Tailwind
TAILWIND_APP_NAME = "catalog.theme"
