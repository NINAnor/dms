...
SECRET_KEY = env(
    ...
    default="iUb7AqZQ5PzH8EeOdXOQgwwvfhbtyQWuziGY8XfG6hAM1KVwH0Ukt8q4nAuKHF5m",  # pragma: allowlist secret  # noqa: E501
)
...
MIGRATION_LINTER_OPTIONS = {"sql_analyser": "postgresql"}
